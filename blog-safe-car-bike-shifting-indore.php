...
<div class="faq-box">
    ...
    <p>Clean the car, record existing scratches on video with the driver, keep the fuel tank at 1/4th level, remove toll FASTags and valuables, and provide a spare key.</p>
                    ...
                    <div class="social-share-block" style="background:#f9f9f9; padding: 15px 20px; border-radius: 4px; font-size: 15px;">
                        ...
                        <a href="https://api.whatsapp.com/send?text=Car & Bike Transport in Indore — Charges, Carriers & Safe Transit Process (2026): https://www.apnapackersmovers.com/blog-safe-car-bike-shifting-indore.php" target="_blank" style="margin-right: 15px; color: #25D366; font-weight: bold;"><i class="fa fa-whatsapp"></i> WhatsApp</a>
                        <a href="https://www.facebook.com/sharer/sharer.php?u=https://www.apnapackersmovers.com/blog-safe-car-bike-shifting-indore.php" target="_blank" style="margin-right: 15px; color: #3b5998; font-weight: bold;"><i class="fa fa-facebook"></i> Facebook</a>
                        <a href="https://twitter.com/intent/tweet?url=https://www.apnapackersmovers.com/blog-safe-car-bike-shifting-indore.php&text=Car & Bike Transport in Indore — Charges, Carriers & Safe Transit Process (2026)" target="_blank" style="margin-right: 15px; color: #1da1f2; font-weight: bold;"><i class="fa fa-twitter"></i> Twitter</a>
