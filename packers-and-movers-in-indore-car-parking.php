    ...
    <div class="container-fluid block-content" style="padding-top: 35px; padding-bottom: 50px;">
        <div class="row">
            ...
            <div class="col-sm-9 main-content" style="font-size:15.5px; line-height:1.8;">
                ...
                <img src="https://www.apnapackersmovers.com/images/packers-and-movers-in-Indor.webp" class="full-width wow zoomIn" data-wow-delay="0.2s" alt="Car Transport & Bike Transportation Services in Indore" style="border-radius:4px; margin-bottom:25px;">
