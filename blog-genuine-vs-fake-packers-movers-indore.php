...
<div class="faq-box">
    ...
    <p>Apna Packers is GST registered, IBA compliant, maintains a physical hub at Shop B-3, Goyal Compound, Dewas Naka, Indore, and has served 2500+ satisfied clients across Madhya Pradesh.</p>
                    ...
                    <div class="social-share-block" style="background:#f9f9f9; padding: 15px 20px; border-radius: 4px; font-size: 15px;">
                        ...
                        <a href="https://api.whatsapp.com/send?text=Genuine vs Fake Packers and Movers in Indore (IBA, GST & Scam Prevention Guide): https://www.apnapackersmovers.com/blog-genuine-vs-fake-packers-movers-indore.php" target="_blank" style="margin-right: 15px; color: #25D366; font-weight: bold;"><i class="fa fa-whatsapp"></i> WhatsApp</a>
                        <a href="https://www.facebook.com/sharer/sharer.php?u=https://www.apnapackersmovers.com/blog-genuine-vs-fake-packers-movers-indore.php" target="_blank" style="margin-right: 15px; color: #3b5998; font-weight: bold;"><i class="fa fa-facebook"></i> Facebook</a>
                        <a href="https://twitter.com/intent/tweet?url=https://www.apnapackersmovers.com/blog-genuine-vs-fake-packers-movers-indore.php&text=Genuine vs Fake Packers and Movers in Indore (IBA, GST & Scam Prevention Guide)" target="_blank" style="margin-right: 15px; color: #1da1f2; font-weight: bold;"><i class="fa fa-twitter"></i> Twitter</a>
                        <a href="https://www.linkedin.com/shareArticle?mini=true&url=https://www.apnapackersmovers.com/blog-genuine-vs-fake-packers-movers-indore.php" target="_blank" style="color: #0077b5; font-weight: bold;"><i class="fa fa-linkedin"></i> LinkedIn</a>
                    </div>
                </div>
            </div>
        </div>
