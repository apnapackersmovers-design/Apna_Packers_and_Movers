...
<div class="faq-box">
    ...
    <p>An itemized packing list records each numbered carton, furniture condition, and appliance serial number, signed by both customer and supervisor. In case of transit damage, insurance claims cannot be processed without it.</p>
                    ...
                    <div class="social-share-block" style="background:#f9f9f9; padding: 15px 20px; border-radius: 4px; font-size: 15px;">
                        ...
                        <a href="https://api.whatsapp.com/send?text=Essential Documents Required for House Shifting in India (Paperwork Guide 2026): https://www.apnapackersmovers.com/blog-documents-required-for-house-shifting-india.php" target="_blank" rel="noopener noreferrer" style="margin-right: 15px; color: #25D366; font-weight: bold;"><i class="fa fa-whatsapp"></i> WhatsApp</a>
                        <a href="https://www.facebook.com/sharer/sharer.php?u=https://www.apnapackersmovers.com/blog-documents-required-for-house-shifting-india.php" target="_blank" rel="noopener noreferrer" style="margin-right: 15px; color: #3b5998; font-weight: bold;"><i class="fa fa-facebook"></i> Facebook</a>
                        <a href="https://twitter.com/intent/tweet?url=https://www.apnapackersmovers.com/blog-documents-required-for-house-shifting-india.php&text=Essential Documents Required for House Shifting in India (Paperwork Guide 2026)" target="_blank" rel="noopener noreferrer" style="margin-right: 15px; color: #1da1f2; font-weight: bold;"><i class="fa fa-twitter"></i> Twitter</a>
                        <a href="https://www.linkedin.com/shareArticle?mini=true&url=https://www.apnapackersmovers.com/blog-documents-required-for-house-shifting-india.php" target="_blank" rel="noopener noreferrer" style="color: #0077b5; font-weight: bold;"><i class="fa fa-linkedin"></i> LinkedIn</a>
                    </div>
                </div>
            </div>
        </div>
